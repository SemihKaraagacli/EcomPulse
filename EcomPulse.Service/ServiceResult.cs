...
namespace EcomPulse.Service
{
    public class ServiceResult
    {
        ...
        public static ServiceResult Success(string error, HttpStatusCode statusCode) => new ServiceResult { Errors = [error], HttpStatus = statusCode };
    }
    ...
    public class ServiceResult<T> : ServiceResult
    {
        ...
        public static ServiceResult<T> Success(string error, HttpStatusCode statusCode) => new ServiceResult<T> { Errors = [error], HttpStatus = statusCode };
    }
}